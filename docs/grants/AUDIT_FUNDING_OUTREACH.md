...
2. **OSTIF = audit‑sourcing partner** — best engaged *once NLnet funding is being secured* (say so; it
...
> codebase is complete and reproducible (365 tests, a 23/23 internal conformance report), built on audited
...
> *without* exposing what a user's agent did. That matters for journalists, civil‑society, and at‑risk users
