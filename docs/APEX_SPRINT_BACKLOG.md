...
> that keeps 24-of-24 conformance and the FTO design-around intact).
...
| A5     | Reconcile stale `THREAT_MODEL.md` status → current tests / 24-of-24 / built planes | 5/1/S | status + §0 + §7-R1 reflect reality; §3 trust-boundaries untouched.                                    |
...
| Rank   | Title                                                                              | V/R/E | Definition of Done                                                                                |
| ------ | ---------------------------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------- |
| **B1** | ADR + KAT: pin generator-H provenance (H≠G/identity startup invariants)            | 5/2/S | pinned-H KAT + load-time invariant _specified_, council-approved before gated KAT lands.          |
