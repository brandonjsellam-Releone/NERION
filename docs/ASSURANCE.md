...
| 299 automated tests · 21/21 conformance | Tested · Conformance‑checked | `npm run gate`, `npm run conformance` | Demonstrates **implementation consistency against Nerion's own spec — NOT external security validation, formal proof, or coverage/fuzzing guarantees** |
