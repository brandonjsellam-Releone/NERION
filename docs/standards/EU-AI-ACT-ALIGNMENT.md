...
| Design specifications   | ADR-0001 through ADR-0038 - complete architecture decision records.                   |
| Testing procedures      | conformance/vectors/ps-\*.json KAT vectors; `npm run conformance` (24-of-24 passing). |
