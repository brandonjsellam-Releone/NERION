...
- **P3 — Offline Settlement (batch tier).** A proof-of-stake ledger with *k*-of-*n* quorum governance and accountable-safety / equivocation-slashing settles disputes and anchors long-term roots, signed with SLH-DSA-SHAKE-256f (FIPS 205). A TLA+ model of the accountable-safety property is maintained in-repo.
