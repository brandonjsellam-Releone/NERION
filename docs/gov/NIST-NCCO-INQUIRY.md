...
The project currently passes **756 automated tests** across 102 test files, with **24/24 conformance checks** against the published specification. A Rust hot-path implementation passes 13 tests including byte-exact KAT comparisons against NIST vectors.
