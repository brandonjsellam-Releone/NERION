...
&nbsp;457 tests · 23/23 conformance · UNAUDITED (see [ASSURANCE.md](docs/ASSURANCE.md))
...
(ADR-0002), with **457 passing tests** and a **23/23 conformance report**.
...
```bash
npm ci
npm run gate          # clean-room lint + prettier + tsc + 457 tests
