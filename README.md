...
&nbsp;300 tests · 21/21 conformance · UNAUDITED (see [ASSURANCE.md](docs/ASSURANCE.md))
...
(ADR-0002), with **300 passing tests** and a **21/21 conformance report**.
...
```bash
npm ci
npm run gate          # clean-room lint + prettier + tsc + 300 tests
